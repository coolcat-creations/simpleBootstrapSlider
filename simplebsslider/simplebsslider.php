 ...
 * @subpackage  Fields.BS4 Slider
 *
 * @copyright   Copyright (C) 2017 Coolcat Creations
...
class PlgFieldsSimplebsslider extends FieldsListPlugin
{
	/**
	...
	public function onCustomFieldsPrepareDom($field, DOMElement $parent, JForm $form)
	{
		...
		if (!$fieldNode)
		{
			...
			$fieldNode->setAttribute('label', 'PLG_FIELDS_SIMPLEBSSLIDER_PARAMS_DIRECTORY_LABEL');
			$fieldNode->setAttribute('description', 'PLG_FIELDS_SIMPLEBSSLIDER_PARAMS_DIRECTORY_DESC');
